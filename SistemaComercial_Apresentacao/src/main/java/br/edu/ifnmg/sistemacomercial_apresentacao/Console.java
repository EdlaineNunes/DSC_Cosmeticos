...
import br.edu.ifnmg.sistemacomercial_persistencia.PessoaFisicaDAO;
import br.edu.ifnmg.sistemacomercial_persistencia.PessoaJuridicaDAO;
...
public class Console {
    ...
    public static void criarBase(){
       ...
       //criar Transacao
        ...
        t1.add(new TransacaoItem(pr2, 2));
        t1.add(new TransacaoItem(pr3,4));
        repoTransacao.Salvar(t2);
        
        Transacao t3 = new Transacao(pj1,TransacaoTipo.Compra, user3);
        t1.add(new TransacaoItem(pr1, 15));
        t1.add(new TransacaoItem(pr2,9));
